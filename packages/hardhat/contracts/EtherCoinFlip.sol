...
contract EtherCoinFlip {
    ...
    event startedCoinFlip(uint256 indexed theCoinFlipID);
    ...
    function newCoinFlip() public payable returns (uint256 coinFlipID) {
        ...
        emit startedCoinFlip(coinFlipID);
    }
    ...
    function endCoinFlip(uint256 coinFlipID) public payable {
        ...
        uint256 randomResult = block.prevrandao + block.chainid + block.gaslimit + block.number + block.timestamp;
